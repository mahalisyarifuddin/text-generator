...
is_rtl = any(lang in ("ar", "he", "fa") for lang in input_languages)
...
file_output += "." + ("</bdo>" if is_rtl else "") + "&nbsp;&#150;&nbsp;generated by the <a href='https://justanotherfoundry.com'>JAF</a> Test Text Generator [https://justanotherfoundry.com]"
